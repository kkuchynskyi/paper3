...
- This project uses `cleveref`; use `\Cref` at sentence start and `\cref` mid-sentence. `\Cref` makes it easier to navigate through the generated PDF.
...
- Each `section` and `subsection` should start with a specific comment duplicating the section title and ~20 blank lines in order to make it visually distinct and make it easier to navigate through the whole `.tex` file. It is my personal preference. Use a label for each `section` and `subsection`. The example of section
```
% ============================================================
